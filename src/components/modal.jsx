        ...
        <div className=''>
            <div className="  fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
                ...
                modal-content  relative flex flex-col w-[500px] h-[289px] rounded-2xl shadow-lg  `} >
                    ...
                    focus:outline-none py-2 pl-4 mx-7 rounded-lg text-base border  `}
                        value={props.noteInput} onChange={changeHandler} />
                    <div className='flex justify-between '>
                        ...
                        <button className=' text-[white] bg-[#6C63FF]  uppercase py-2 px-6 mr-7 mt-24 rounded-md' type='button' onClick={applyHandler} >Apply</button>
                    </div>
                </div>
            </div>
        </div>
